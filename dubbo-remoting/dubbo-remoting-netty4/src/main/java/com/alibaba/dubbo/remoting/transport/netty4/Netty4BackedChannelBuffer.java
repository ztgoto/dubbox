...
public class Netty4BackedChannelBuffer implements ChannelBuffer {
    ...
    public ChannelBuffer copy(int index, int length) {
        return new Netty4BackedChannelBuffer(buffer.copy(index, length));
    }
    ...
    public ChannelBuffer copy() {
        return new Netty4BackedChannelBuffer(buffer.copy());
    }
    ...
    public ChannelBuffer readBytes(int length) {
        return new Netty4BackedChannelBuffer(buffer.readBytes(length));
    }
